...
Flutter по умолчанию ходит на **`https://api.anti-toxic.ru`**. Локальный API на ПК:  
`flutter run --dart-define=API_BASE_URL=http://127.0.0.1:8000`  
**Эмулятор Android** к API на хосте: `--dart-define=API_BASE_URL=http://10.0.2.2:8000`  
Другой прод: `--dart-define=API_BASE_URL=https://…`
...
Сборка/запуск Flutter: **по умолчанию** уже этот API (`AppEnv`). Явно задать URL при необходимости:
